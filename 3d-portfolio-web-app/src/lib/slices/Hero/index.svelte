...
<section class="bg-gray-400 px-4 md:px-6" data-slice-type={slice.slice_type} data-slice-variation={slice.variation}>
	<div class="mx-auto w-full max-w-7xl">
		<div class="grid min-h-[65vh] grid-cols-1 items-center md:grid-cols-2">
			...
			<div class="col-start-1 md:row-start-1">
				...
				<span class="block bg-gradient-to-tr from-yellow-500 via-yellow-200 to-yellow-600 bg-clip-text text-transparent text-2xl font-bold uppercase tracking-[.2em]" >
